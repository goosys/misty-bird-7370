Rails.application.config.after_initialize do
  ...
  Administrate::Engine.add_stylesheet 'vendor/trix' # Propshaftの場合は追加する（manifest.jsにも追加する）
  Administrate::Engine.add_stylesheet 'vendor/selectize.default' # Propshaftの場合は追加する（manifest.jsにも追加する）
